export default [
  ...
  {
    id: '6b0d3f12-590f-4e0c-a743-930fc4d42b32',
    title: 'Amazon on campus',
    body:
  ...
  {
    id: 'd06eaeae-01ec-4390-bc44-7be06159eba9',
    ...
    pages: ['Dashboard'],
    action: {
      title: 'Go to the Alert Portal',
      link:
        'https://proxy.qualtrics.com/proxy/?url=https%3A%2F%2Foregonstate.edu%2Falerts%2Fosu-alert-portal&token=QE9LytTaaBHkw66ZLRk0zu6zVTapVNkvpO85gm3wHv8%3D',
    },
  },
  {
  ...
  {
    id: '7c0f8ffb-24c6-403b-b3fa-3ba0fd7ffbb9',
    title: 'Wellness Nook Opens',
    body:
    ...
    audiences: ['Corvallis'],
    pages: ['Dashboard'],
    action: { title: 'Stop by the Wellness Nook ', link: 'https://wellnessnook.oregonstate.edu' },
  },
  {
    id: 'a8788809-4dbe-49df-ad84-911b18b5749c',
    ...
    pages: ['Dashboard'],
    action: {
      title: 'How do I coffee nap?',
      link: 'https://www.sciencedirect.com/science/article/pii/S1388245703002554',
    },
  },
  {
    id: '34043ff9-232e-4387-b452-a8109ed29579',
    title: 'Need support? ',
    body:
    ...
    action: {
      title: 'Reach Out',
      link:
        'https://proxy.qualtrics.com/proxy/?url=https%3A%2F%2Foregonstate.edu%2Freachout&token=Z1CWyybpeZk13rHUCgVR20ypkLs9J1fMP50ljeUfzMg%3D',
    },
  },
  {
    id: '8983b1a5-dc2a-4680-94f4-f3a0e3205e1e',
    title: 'Hey Beavs, want to improve your finals grades? ',
    body:
    ...
    pages: ['Academics'],
    action: {
      title: 'Visit with an ASC strategist',
      link:
        'https://proxy.qualtrics.com/proxy/?url=https%3A%2F%2Fsuccess.oregonstate.edu%2Fstudent-strategists&token=uQI4YJ29P1S1nVxcIPkJFC0rYawV89Wm3rf%2FheLbHa4%3D',
    },
  },
  {
  ...
  },
  {
    ...
    pages: ['Dashboard'],
    action: { title: 'Sign up now.', link: 'https://is.oregonstate.edu/duo' },
  },
];
