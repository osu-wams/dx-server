export const personsAddressesData: any = {
  data: [
    {
      id: '111',
      type: 'addresses',
...
export const personsMailingAddressData: any = {
  id: '111',
  type: 'addresses',
  attributes: {
    addressType: 'CM',
...
export default personsAddressesData;
